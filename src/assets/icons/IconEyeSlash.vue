<template>
  <!--
    Eye-slash icon – indicates that content is hidden.
    Uses a filled SVG (Bootstrap Icons style).
  -->
  <svg
...
<script setup>
/**
 * @file IconEyeSlash.vue
 * @description Reusable "eye-slash" (closed) SVG icon component.
 *
 * Props:
 * - size (Number|String): Width & height in px. Default 18.
 *
 * Accessibility:
 * - aria-hidden="true" (toggle button provides its own label)
 * - focusable="false"
 */
defineProps({
